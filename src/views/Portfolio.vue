...
const projects = ref([
  {
    ...
    github: 'https://github.com/joechiboo/honey-mishears',
    category: 'fun',
    year: '2026',
  ...
  },
  {
    ...
    technologies: ['Python', 'OpenAI API', 'gpt-image-1', 'Pillow', 'JSON', 'GitHub Pages'],
    demo: 'https://joechiboo.github.io/bard-comics/',
  ...
  },
  {
    ...
    demo: 'https://joechiboo.github.io/tempokid/',
    github: 'https://github.com/joechiboo/tempokid',
    category: 'tool',
    year: '2026',
